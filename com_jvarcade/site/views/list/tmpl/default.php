...
<div id="puarcade_wrapper">
	...
	<br /><center><a href="<?php echo Joomla\CMS\Router\Route::_('index.php?option=com_jvarcade&view=home', false); ?>"><?php echo JText::_('COM_JVARCADE_CHOOSE_ANOTHER_FOLDER'); ?></a></center>
	<?php endif; ?>
